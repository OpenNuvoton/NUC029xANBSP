 ...
 * $Revision: 3 $
 * $Date: 15/07/01 3:16p $
 * @brief    NUC029 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NUC029 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
typedef struct
{
     ...
     * |        |          |NuMicro NUC029 series equips with a maximum 16kx32 embedded flash, it supports word program
...
typedef struct
{
     ...
     * DMASK
     * ===================================================================================================
     * 0x0C/0x4C/0x8C/0xCC/0x10C Port 0-4 Data Output Write Mask
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
typedef struct
{
     ...
     * |[23:16] |ADC_N     |ADC Clock Divide Number from ADC peripheral Clock Source
     ...
     * |        |          |where Fin is the input clock frequency, Fout is the frequency of divider output clock, N is the 4-bitvalue of FSEL[3:0].

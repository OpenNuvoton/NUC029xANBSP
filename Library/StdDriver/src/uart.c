 ...
 * $Revision: 7 $
 * $Date: 16/03/04 9:41a $
 * @brief    NUC029 series UART driver source file
 *
 * @note
...
/** @addtogroup NUC029_UART_Driver UART Driver
  @{
*/


/** @addtogroup NUC029_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
 ...
 *                                      - \ref UART_ISR_LIN_RX_BREAK_INT_Msk  : LIN bus interrupt
 *                                      - \ref UART_ISR_BUF_ERR_INT_Msk       : Buffer Error interrupt
 *                                      - \ref UART_ISR_MODEM_INT_Msk         : Modem interrupt
 *                                      - \ref UART_ISR_RLS_INT_Msk           : Rx Line status interrupt
 *
 *    @return       None
 *
 ...
 *    @param[in]    uart                The pointer of the specified UART module.
 *    @param[in]    u32InterruptFlag    The specified interrupt of UART module.
 *                                      - \ref UART_IER_LIN_RX_BRK_IEN_Msk : LIN bus interrupt
 ...
 *                              - \ref UART_ALT_CSR_RS485_NMM_Msk
 *                              - \ref UART_ALT_CSR_RS485_AUD_Msk
 *                              - \ref UART_ALT_CSR_RS485_AAD_Msk
...
/*@}*/ /* end of group NUC029_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029_UART_Driver */

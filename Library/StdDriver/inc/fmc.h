 ...
 * $Revision: 4 $
 * $Date: 15/05/29 2:19p $
 * @brief    NUC029 Series Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup NUC029_FMC_Driver FMC Driver
  @{
*/

/** @addtogroup NUC029_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_FMC_EXPORTED_CONSTANTS */

extern int32_t g_FMC_i32ErrCode;

/** @addtogroup NUC029_FMC_EXPORTED_FUNCTIONS FMC Exported Functions
  @{
*/
 ...
 * @return     None
 *
 * @details    This function will clear LDUEN bit of ISPCON control register to disable LDROM update function.
 *
 */
...
/*@}*/ /* end of group NUC029_FMC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029_FMC_Driver */

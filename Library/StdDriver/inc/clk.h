 ...
 * $Revision: 7 $
 * $Date: 17/07/24 1:34p $
 * @brief    NUC029 Series Clock Control Driver Header File
 *
 * @note
...
/** @addtogroup NUC029_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup NUC029_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_CLK_EXPORTED_CONSTANTS */


/** @addtogroup NUC029_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029_CLK_Driver */

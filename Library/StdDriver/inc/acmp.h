 ...
 * $Revision: 3 $
 * $Date: 14/10/17 2:58p $
 * @brief    NUC029 series Analog Comparator(ACMP) driver header file
 *
 * @note
...
/** @addtogroup NUC029_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_ACMP_EXPORTED_CONSTANTS */

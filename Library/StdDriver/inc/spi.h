 ...
 * $Revision: 3 $
 * $Date: 14/10/17 4:01p $
 * @brief    NUC029 series SPI driver header file
 *
 * @note
...
/** @addtogroup NUC029_SPI_Driver SPI Driver
  @{
*/

/** @addtogroup NUC029_SPI_EXPORTED_CONSTANTS SPI Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_SPI_EXPORTED_CONSTANTS */


/** @addtogroup NUC029_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/**
  ...
  *             The length of suspend interval is ((u32SuspCycle + 0.5) * the length of SPI bus clock cycle).
  */
...
/*@}*/ /* end of group NUC029_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029_SPI_Driver */

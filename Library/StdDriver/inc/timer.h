 ...
 * $Revision: 2 $
 * $Date: 14/10/03 5:41p $
 * @brief    NUC029 series Timer driver header file
 *
 * @note
...
/** @addtogroup NUC029_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup NUC029_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup NUC029_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029_TIMER_Driver */

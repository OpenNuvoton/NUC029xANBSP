 ...
 * $Revision: 3 $
 * $Date: 14/10/06 6:08p $
 * @brief    NUC029 series PWM driver header file
 *
 * @note
...
/** @addtogroup NUC029_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup NUC029_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_PWM_EXPORTED_CONSTANTS */


/** @addtogroup NUC029_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029_PWM_Driver */

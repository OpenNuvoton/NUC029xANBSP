...
/** @addtogroup NUC029_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC029_ADC_EXPORTED_CONSTANTS */
...
/**
  ...
  * @note While using VBG as channel 7 source, ADC module clock must not exceed 300kHz.
  */
...
/**
  ...
  *                     - \ref ADC_CMP1_INT         :Comparator 1 interrupt flag.
  * @return  None
  * @details ADF (ADSR[0])/CMPF0 (ADSR[1])/CMPF1 (ADSR[2]) can be cleared by writing 1 to itself.
  */
...
/**
  ...
  * @details ADSR[3] (BUSY) is a mirror of ADCR[11] (ADST).
  */

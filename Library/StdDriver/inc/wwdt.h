 ...
 * $Revision: 2 $
 * $Date: 14/10/03 5:45p $
 * @brief    NUC029 series WWDT driver header file
 *
 * @note
...
/** @addtogroup NUC029_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC029_WWDT_EXPORTED_CONSTANTS */

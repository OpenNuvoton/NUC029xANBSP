 ...
 * $Revision: 4 $
 * $Date: 14/12/01 9:01a $
 * @brief    NUC029 Series General Purpose I/O Driver Header File
 *
 * @note
...
/** @addtogroup NUC029_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029_GPIO_EXPORTED_CONSTANTS */
 ...
 *              Example: _GPIO_SET_DEBOUNCE_TIME(GPIO_DBCLKSRC_LIRC, GPIO_DBNCECON_DBCLKSEL_4). \n

/***************************************************************************//**
 * @file     fmc_user.c
 * @brief    NUC029xAN series FMC driver source file
 * @version  2.0.0
 *
...
{
    // For NUC029xAN series, CONIFG2 must be 0xFFFFFF5A (Don't modify this value. It should be 0xFFFFFF5A after reset.)
